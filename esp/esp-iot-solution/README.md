## THIS IS A TRIMMED-DOWN-TO-ALMOST-NOTHING version from ~Nov2021
## see the placehoder file for a rough idea how to fetch the whole thing.
## all this project needs is the bme and bus support
## Notice the apache license
## -ch
